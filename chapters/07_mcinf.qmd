...
The Giri ratio is applied in economics to measure inequality in income distribution. Note that $G$ can be written in terms of the order statistics $x_{(i)}$ as 
$$
